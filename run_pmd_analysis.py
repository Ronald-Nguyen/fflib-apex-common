...
PATH = "sfdx-source\\apex-common\\main"
...
def run_pmd_command(ruleset="pmd-ruleset.xml", report_file="pmd-report.xml", src_dir=PATH):
...
if __name__ == "__main__":
    ...
    if not os.path.exists(PATH):
        print(f"Warning: '{PATH}' directory not found. Please ensure it exists before running.")
    else:
        run_pmd_command()
